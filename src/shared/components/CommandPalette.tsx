          ...
          {filtered.map((item, i) => (
            <li key={item.to}>
              <button
                ...
                className={`flex w-full items-center justify-between rounded-lg px-3 py-2.5 text-left text-sm transition-colors ${i === selected ? 'bg-accent-50 text-accent-700' : 'text-ink-700 hover:bg-ink-100/50'}`}
              >
